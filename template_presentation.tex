...
%
% modified version by camilocarvajalreyes
%
%!TEX program = xelatex
...
\newcommand{\titlepageImage}{Images/Imperial_campus-snow.jpg}
...
% \usepackage{biblatex}
\AtBeginBibliography{\scriptsize}  % smaller font for references
...
\begin{frame}
	...
	\begin{columns}[T] % [T] ensures correct vertical alignment
		...
		\begin{column}{0.48\linewidth} % Right column
            ...
            Example citation: \cite{ekman_universals_1971}.
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{theorem}[Just a theorem]
		For integers $n>2$, the equation
		\[ a^n + b^n = c^n \]
		cannot be solved for integers $a$, $b$ and $c$.
	\end{theorem}

	\begin{theorem}[Approximation theorem for sigmoid activation functions]
		\label{teo:AU}
...
\ReferenceSlides
% \ReferenceSlides[allowframebreaks]  % if citations don't fit in a single page
...
%---------------- Repeating the first slide, can be removed --------------------------------
